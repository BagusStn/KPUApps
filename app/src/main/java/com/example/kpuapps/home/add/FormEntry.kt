...
import com.example.kpuapps.camera.CameraActivity
import com.example.kpuapps.camera.rotateBitmap
import com.example.kpuapps.camera.uriToFile
import com.example.kpuapps.database.DataPemilih
import com.example.kpuapps.databinding.ActivityEntryBinding
...
class FormEntry : AppCompatActivity() {
    ...
    private var _activityFormEntryBinding: ActivityEntryBinding? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        _activityFormEntryBinding = ActivityEntryBinding.inflate(layoutInflater)
    ...
    private val launcherIntentCameraX = registerForActivityResult(
        ...
        if (it.resultCode == CAMERA_X_RESULT) {
            ...
            val path = MediaStore.Images.Media.insertImage(
                this@FormEntry.contentResolver,
                result,
                "Title",
                null
            )
